...
const organizationSendMail = (req, res) => {
    const { name, email, company, phone, projectIdea } = req.body;
    ...
    if (!name || !email || !company || !phone || !projectIdea) {
        return res.status(400).send('All fields are required.');
    }
...
const OrganizationContactUsEmailFormate = (name, email, company, phone, projectIdea) => {
    return `
<html>
        <head>
            <style>
        ...
        <body>
            <div class="container">
                ...
                <p><span class="highlight">Project Idea:</span> ${projectIdea}</p>
                <div class="divider"></div>
